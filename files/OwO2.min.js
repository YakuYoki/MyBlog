  ...
  var e=function() {
    function e(t) {
      ...
      _classCallCheck(this,e);
	    var s = {
        logo:"OwO鐞涖劍鍎�",
        container:document.getElementsByClassName("OwO")[0],target:document.getElementsByTagName("textarea")[0],position:"down",
        width:"100%",
        maxHeight:"250px",
      ...
      this.target=t.target,"up"===t.position&&this.container.classList.add("OwO-up");
    ...
    return _createClass(e,[{key:"init",value:function(e) {
      var t=this;
      this.area=e.target,
    ...
    this.logo.addEventListener("click",function(){t.toggle();}),
    this.container.getElementsByClassName("OwO-body")[0].addEventListener("click",function(e) {
        ...
        t.area.value=n.slice(0,s)+num+n.slice(s),
        t.area.focus(),
        t.toggle();
